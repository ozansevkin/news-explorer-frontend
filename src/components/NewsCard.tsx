...
export default function NewsCard() {
  return (
    <article className="max-w-[400px] relative flex flex-col rounded-lg overflow-hidden hover:shadow-lg">
      <a href="#" target="_blank">
        ...
        <div className="flex flex-col p-4 sm:px-6 sm:pb-6 sm:pt-5">
          <time
            dateTime="2018-07-07"
          ...
          <h3 className="font-serif text-[22px] sm:text-[26px] leading-normal sm:leading-[30px] mt-[10px] sm:mt-3">
            Title
          </h3>
